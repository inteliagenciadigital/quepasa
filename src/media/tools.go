...
// var logentry qplog.Logger = qplog.New()
//
//	func init() {
//	   logentry.SetFormatter(&qplog.JSONFormatter{})
//	   logentry.SetOutput(os.Stdout)
//	   logentry.SetLevel(qplog.InfoLevel) // Set your desired log level
//	}
var logentry qplog.Logger = qplog.New() // Default initialization. Prefer external configuration.
