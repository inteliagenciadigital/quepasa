...
//	@Tags			Restore
//	@Produce		json
//	@Success		200	{object}	models.RestoreReport
...
// Authentication: master key required.
//
// The algorithm applies an automatic restore only when there is exactly one
// orphan device and one unlinked server, making the match unambiguous.
//
// Any ambiguous cases (multiple orphans or multiple servers) are
...
//	@Accept			json
//	@Produce		json
//	@Param			request	body	object{token=string,jid=string}	true	"Manual restore payload"
//	@Success		200	{object}	object{result=string,token=string,jid=string}
//	@Failure		400	{object}	models.QpResponse
//	@Failure		401	{object}	models.QpResponse
//	@Failure		500	{object}	models.QpResponse
//	@Security		ApiKeyAuth
//	@Router			/restore/manual [post]
