...
func (ws *WakeUpScheduler) executeWakeUp(duration time.Duration, logentry log.Logger) {
...
func (ws *WakeUpScheduler) sendPresence(presence types.Presence, logentry log.Logger, reason string) {
