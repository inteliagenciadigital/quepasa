...
func HandleTextMessage(log log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.Message) {
...
func HandleEditTextMessage(log log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.FutureProofMessage) {
	// never throws, obs !!!!
...
func HandleProtocolMessage(logentry log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.ProtocolMessage) {
...
func HandleEphemeralMessage(handler *WhatsmeowHandlers, logentry log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.FutureProofMessage) {
	if in == nil {
		return
	}
...
func HandleExtendedTextMessage(logentry log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.ExtendedTextMessage) {
...
func HandleReactionMessage(log log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.ReactionMessage) {
...
func HandleButtonsResponseMessage(log log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.ButtonsResponseMessage) {
...
func HandleStickerMessage(log log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.StickerMessage) {
...
func HandleVideoMessage(log log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.VideoMessage) {
...
func HandleDocumentMessage(logentry log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.DocumentMessage) {
...
func HandleAudioMessage(log log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.AudioMessage) {
...
func HandleLocationMessage(logentry log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.LocationMessage) {
...
func HandleLiveLocationMessage(logentry log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.LiveLocationMessage) {
...
func HandleContactMessage(log log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.ContactMessage) {
...
func HandleContactsArrayMessage(handler *WhatsmeowHandlers, logentry log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.ContactsArrayMessage) {
