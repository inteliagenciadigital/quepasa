...
func ResolveCallIdentifiers(evt types.BasicCallMeta, logentry log.Logger) CallIdentifiers {
...
func EnrichCallChat(handler *WhatsmeowHandlers, chat *whatsapp.WhatsappChat, identifiers CallIdentifiers, chatJID types.JID, logentry log.Logger) {
