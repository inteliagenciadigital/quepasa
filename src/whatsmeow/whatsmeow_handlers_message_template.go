...
func HandleTemplateMessage(logentry log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.TemplateMessage) {
...
func HandleTemplateButtonReplyMessage(logentry log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.TemplateButtonReplyMessage) {
...
func HandleHydratedTemplate(logentry log.Logger, out *whatsapp.WhatsappMessage, in *waE2E.TemplateMessage_HydratedFourRowTemplate) {
